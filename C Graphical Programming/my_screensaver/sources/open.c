...
void event_two(sfRenderWindow *window, sfEvent event)
{
...
int add(void)
{
    ...
    fix(framebuffer, window, texture, sprite);
    return 0;
}

void third_main(int argc, char **argv)
{
    if (argc == 2)
...
void second_main(int argc, char **argv)
{
    if (argc == 2)
